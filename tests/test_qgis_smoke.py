...
class QgisSmokeTests(unittest.TestCase):
    ...
    def test_dock_widget_contextual_help_smoke(self):
        ...
        try:
            ...
            self.assertEqual(dock.activitiesGroupBox.title(), "1. Fetch / store database")
            ...
            self.assertEqual(dock.analysisWorkflowGroupBox.title(), "3. Analyze")
            self.assertEqual(dock.publishGroupBox.title(), "4. Publish / atlas")
