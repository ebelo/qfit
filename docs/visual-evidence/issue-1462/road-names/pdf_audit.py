...
for v in ('3','4'):
 for camera in ('cairo-nile-z14','jerusalem-city-z14'):
  for variant in ('pdf-before','pdf-after'):
  ...
  for i,(path,label) in enumerate([(P/'reference-mercator'/camera/'mapbox.png','Mapbox PNG reference (context)'),(P/v/camera/'pdf-before/pdf150.png',f'QGIS{v} PDF150 Before @96DPI'),(P/v/camera/'pdf-after/pdf150.png',f'QGIS{v} PDF150 After @96DPI')]):
   panel.paste(Image.open(path).crop((400,260,780,560)),(i*380,35));draw.text((i*380+8,10),label,fill='black')
