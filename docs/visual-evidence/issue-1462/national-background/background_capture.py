...
parser.add_argument('--variant',choices=['control','repeat','production','final','width-opacity','width-only','opacity-only'],default='control')
...
if args.mode=='native':
    ...
    variant='candidate' if args.variant in ('production','final') else 'baseline'
